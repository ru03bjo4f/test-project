...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_users_role" AS ENUM('admin', 'editor', 'author', 'subscriber');
  CREATE TABLE "posts" (
  ...
  CREATE TABLE "site_settings_main_menu" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "site_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"site_name" varchar DEFAULT '我的網站' NOT NULL,
  ...
  ALTER TABLE "site_settings_main_menu" ADD CONSTRAINT "site_settings_main_menu_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."site_settings"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "site_settings_main_menu_order_idx" ON "site_settings_main_menu" USING btree ("_order");
  CREATE INDEX "site_settings_main_menu_parent_id_idx" ON "site_settings_main_menu" USING btree ("_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "site_settings_main_menu" CASCADE;
